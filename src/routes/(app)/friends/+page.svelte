...
{#snippet navItem({ text, icon, background, onclick }, id)}
	<button onclick={()=>{onclick(id)}} type="button"
					class="inline-flex items-center gap-x-1.5 rounded-md {background} px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-teal-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600">
		...
		<div class="mt-3 sm:mt-4">
			...
			<div class="hidden sm:block">
				<nav class="-mb-px flex space-x-8">
					<button
						class=" {tab === 0 ? 'border-teal-500 text-teal-500': 'text-gray-400 border-transparent '} hover:border-teal-600 hover:text-teal-600 whitespace-nowrap border-b-2 px-1 pb-4 text-sm font-medium"
						onclick={()=>{tab = 0}}>All
					</button>
					<button
						class="{tab === 1 ? 'border-teal-500 text-teal-500': 'text-gray-400 border-transparent '} hover:border-teal-600 hover:text-teal-600 whitespace-nowrap border-b-2 px-1 pb-4 text-sm font-medium"
						onclick={()=>{tab = 1}}>Online
					</button>
					<button
						class="{tab === 2 ? 'border-teal-500 text-teal-500': 'text-gray-400 border-transparent '} over:border-teal-600 hover:text-teal-600 whitespace-nowrap border-b-2 px-1 pb-4 text-sm font-medium"
						onclick={()=>{tab = 2}}>Requests
					</button>
		...
		<ul role="list" class="">
			...
			<li class="relative flex justify-between gap-x-6  py-5 ">
				<div class="flex min-w-0 gap-x-4">
					<img class="h-12 w-12 flex-none rounded-md ring-2 ring-gray-400  ring-opacity-75"
							 src="https://cdn.discordapp.com/avatars/1226135412150505503/b6e0faa1d24b06aef215deef6fdd0a6e?size=1024"
							 alt="">
				...
				<div class="flex shrink-0 items-center gap-x-4">
					<div class="hidden sm:flex gap-4 sm:items-end">
						<button onclick={()=>{tab = 3}} type="button"
										class="inline-flex items-center gap-x-1.5 rounded-md bg-teal-600 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-teal-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600">
